...
var EventDefinition = require('./objects/EventDefinition');
var Folder = require('./objects/Folder');
var InteractionEvent = require('./objects/InteractionEvent');
...
ET_Client.prototype.eventDefinition = function(options) {
    return new EventDefinition(this, options);
}
...
ET_Client.prototype.interactionEvent = function(options) {
    return new InteractionEvent(this, options);
};

ET_Client.prototype.journey = function(options) {
    return new Journey(this, options);
};
